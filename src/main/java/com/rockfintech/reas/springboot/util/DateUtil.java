package com.rockfintech.reas.springboot.util;
...
public class DateUtil {
	...
	private final static String DAY_FORMAT_H = "HHmmss";
	 ...
	 * @return
	 */
	public static String getCurFullDate(Date date) {
		return getFormatDate(date, FULLDATE_FORMAT);
	}
	 ...
	 * @return
	 */
	public static Date getFormatDate_(String currDate) {
	...
	public static String getFormatTime(Date currDate) {
		...
		return getFormatDate(currDate, DAY_FORMAT_H);
	}
	...
	public static String getFormatDayH(Date currDate) {
		return getFormatDate(currDate, DAY_FORMAT_H);
	}
	...
	public static Date formatDate(String formatString, Date date) throws ParseException {
		...
		date = DateUtil.convertString2Date(formatString, DateUtil.convertDate2String(formatString, date));
	...
	public static int getOverdueDays(Date startTime, Date endTime) {
		...
		int overDays = DateUtil.getDaysBetween(startCal, endCal);
...
//	getFormatDateTime
	public static void main(String [] args){
		Date d1 = getFormatDateTime("2018-05-23 23:00:00");
		Date d2 = getFormatDate_("20180523240000");
		int i = compare_date(d1,d2);
		System.out.print("==========" + i);
	}
