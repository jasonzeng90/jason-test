package com.rockfintech.reas.xabank.util.http;


import com.rockfintech.reas.xabank.common.constant.Request;
import com.rockfintech.reas.xabank.util.CommonUtil;
...
public class HttpClient {
    ...
    public HttpURLConnection connect(String url, String method) throws MalformedURLException, IOException {
        ...
        String proxyHost = "0";
        String proxyPort = "0";
        if(!"0".equals(proxyHost) && !"0".equals(proxyPort)){
    ...
    public int send(HttpURLConnection connection, String requestData, File file, String signature) throws IOException {
        if (requestData != null) {
            ...
            sb.append(BOUNDARY);
            sb.append(LINEND);
            sb.append("Content-Disposition: form-data; name=\"xabank\"" + LINEND);
            sb.append(LINEND);
            sb.append(signature);
            sb.append(LINEND);
